...
import (
	...
	"github.com/ezotaka/proglog/internal/loadbalance"
	"github.com/ezotaka/proglog/internal/server"
...
func TestResolver(t *testing.T) {
	...
	_, err = r.Build(
		resolver.Target{
			Endpoint: l.Addr().String(), // TODO: deprecated
		},
		conn,
		opts,
	)
...
// GetServers implements server.GetServerer
func (*getServers) GetServers() ([]*api.Server, error) {
	return []*api.Server{{
		Id:       "leader",
...
// NewAddress implements resolver.ClientConn
func (*clientConn) NewAddress(addresses []resolver.Address) {
}

// NewServiceConfig implements resolver.ClientConn
...
// UpdateState implements resolver.ClientConn
